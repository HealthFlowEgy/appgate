        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              //   },
              //   child: Text(
              //     AppLocalization.instance.getLocalizationFor("skipLogin"),
              //     textAlign: TextAlign.center,
              //     style: theme.textTheme.bodyLarge,
              //   ),
              // ),
              const Spacer(flex: 2),
              if (AppConfig.fireConfig.isSocialAuthEnabled)
                Text(
                  AppLocalization.instance.getLocalizationFor("orContinueWith"),
                  textAlign: TextAlign.center,
                ),
              if (AppConfig.fireConfig.isSocialAuthEnabled)
                const Spacer(flex: 3),
                    ...
                    if (AppConfig.fireConfig.enableSocialAuthGoogle)
                      Expanded(
                        child: buildSocialButton(
                          ...
                          AppLocalization.instance.getLocalizationFor("google"),
                        ),
                      ),
