...
class AuthCubit extends Cubit<AuthState> implements VerificationCallbacks {
      ...
      if (isValid) {
        try {
          ...
          if (normalizedNumber != null) {
            bool isRegistered =
                await _repository.isRegistered(normalizedNumber);
  ...
  void initRegistration(String countryCode, String phoneNumber, String name,
            ...
            if (errorResponse.containsKey("errors")) {
              if ((errorResponse['errors'] as Map<String, dynamic>)
                ...
                errorState = RegisterError(
                    (errorResponse['errors']['email'] as List<dynamic>)
                            .isNotEmpty
