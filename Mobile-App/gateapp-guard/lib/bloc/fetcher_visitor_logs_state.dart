...
class CreateVisitorLogLoading extends FetcherVisitorLogsLoading {
  const CreateVisitorLogLoading();
}

class CreateVisitorLogLoaded extends FetcherVisitorLogsLoaded {
...
class CreateVisitorLogFail extends FetcherVisitorLogsFail {
...
class VisitorLogUpdateLoaded extends FetcherVisitorLogsLoaded {
  final VisitorLog visitorLog;
  const VisitorLogUpdateLoaded(this.visitorLog);
