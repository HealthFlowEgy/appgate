...
import { Env } from '../../../@core/models/setting/env';
...
export class SystemComponent implements OnInit {
  ...
  mailDriverList: Array<string> = ['mailgun', 'smtp', 'ses'];
  showProgress: boolean = false;
  showProgressButton: boolean = false;

  constructor(private client: SettingClient, public coreService: CoreService, public route: ActivatedRoute) {
  }
  ...
  updateEnv() {
    ...
    for (const key of Object.keys(this.env)) {
      formData.append(key, this.env[key]);
    }

    this.client.updateEnv(formData).subscribe(
      res => {
