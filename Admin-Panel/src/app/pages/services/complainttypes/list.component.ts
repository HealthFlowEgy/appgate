...
@Component({
  selector: 'complainttype-list',
  templateUrl: './list.component.html',
  styleUrls: ['./list.component.scss'],
})
export class ComplaintTypeListComponent extends BaseListComponent implements OnInit {
  columns = [
    {
      key: 'id',
...
sort: false,
  ...
  editPageUrl = 'pages/services/edit';
  ...
  ngOnInit(): void {
    super.ngOnInit(this.client.getBaseEndpoint() + '?scope=complaint_type');
  }
}
